...
- 调研笔记：`docs/research/notes/`（Cookie API、重放上下文、Bridge 差距、Service 侧需求）
- POC：[poc/README.md](poc/README.md)，`node poc/service/run-poc.mjs` 用独立扩展 + 真实 Chrome for Testing 跑 27 项检查
